-- ============================================================================
-- AdvancedHadith unified schema (ARCH §6.2) — Postgres 16 + Apache AGE
...
-- ----------------------------------------------------------------------------
-- works & editions
-- A "work" is the abstract book (e.g. صحيح البخاري); an "edition" is one
...
-- ----------------------------------------------------------------------------
-- passages: the single text-unit table for all three sources (§6.1 principle 1)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- narrators (رجال الحديث) — populated in Phase 6
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- translations (§11) — object/field/language grid with review workflow
-- ----------------------------------------------------------------------------
